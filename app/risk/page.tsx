  ...
  return (
    <main>
      ...
      <section style={statsGridStyle}>
        <QualityKpiCard title="Open Risks" value={openRisks} accent="#0f766e" />
...
const barFillStyle: CSSProperties = { height: "100%", borderRadius: "999px", background: "#0f766e", opacity: 0.62 };
