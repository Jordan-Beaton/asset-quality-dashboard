...
const compactTableWrapStyle: CSSProperties = { overflowX: "auto", border: "1px solid #D0D0CE", borderRadius: "14px", background: "#ffffff" };
const registerTableRowStyle: CSSProperties = { cursor: "pointer" };
const selectedTableRowStyle: CSSProperties = { cursor: "pointer", background: "#eef7f8" };
