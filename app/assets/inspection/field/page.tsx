...
export default function AssetInspectionFieldPage() {
  ...
  useEffect(() => {
    async function loadAssets() {
      ...
      setMessage("Choose an asset to start an inspection.");
    }
  ...
  return (
    <main style={pageWrapStyle}>
      <section style={shellStyle}>
        <div style={brandBarStyle}>Asset Field Inspection</div>

        <section style={summaryCardStyle}>
          <div style={eyebrowStyle}>Inspection Asset</div>
        ...
        <section style={assetListStyle}>
          {filteredAssets.map((asset) => {
            ...
            return (
              <Link
                key={asset.id}
                href={`/assets/inspection?asset=${encodeURIComponent(routeValue)}&view=create`}
        ...
        <Link href="/assets/inspection" style={backLinkStyle}>Back to Asset Inspections</Link>
      </section>
    </main>
  );
}
