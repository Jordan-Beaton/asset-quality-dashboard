...
export default function AdminSystemSettingsPage() {
  return (
    <AdminSettingsPage
      ...
      description="Placeholder settings area for organisation details, branding, report defaults, notifications, and governance controls."
      latestLabel="Latest System Setting"
      status="System Settings shell ready. No system configuration is editable in this pass."
      kpis={[
        { title: "Organisation Profile", value: "Future", accent: "#0f766e" },
      ...
      panels={[
        { title: "Future Editable Settings", text: "Organisation details, report header defaults, email sender settings, branding defaults, retention preferences, and governance controls." },
        { title: "Current Pass", text: "Shell only. Existing environment variables, notifications, branding, and report generation remain untouched." },
      ]}
    />
  );
}
