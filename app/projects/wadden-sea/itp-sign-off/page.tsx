...
export default function WaddenSeaItpSignOffPage() {
  ...
  return <main style={page}>
    <QualityPageHero label="Wadden Sea · Documented evidence" title="ITP Sign-Off" description="Select complete ITP phases for external approval or rejection without collecting a drawn signature." />
    <ImsTopMetaRow backHref="/home" backLabel="Back to IMS Home" status={<><strong>Status:</strong> {message}</>} />
    <WaddenSeaWorkspaceNav active="itp-sign-off" />
