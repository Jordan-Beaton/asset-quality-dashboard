...
- Clicking Asset, Inspection, and Maintenance register rows should continue to scroll to the detail panel.
...
5. Review mobile Asset Register behavior against the HSE inspection mobile benchmark.
