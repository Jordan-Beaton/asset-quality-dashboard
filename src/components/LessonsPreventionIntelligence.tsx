...
const cautionCardStyle: CSSProperties = { display: "grid", alignContent: "start", gap: 14, minWidth: 0, padding: 18, borderRadius: 16, border: `1px solid ${imsColours.brandBorder}`, background: imsColours.panel, boxShadow: "0 1px 3px rgba(15,23,42,.08)" };
